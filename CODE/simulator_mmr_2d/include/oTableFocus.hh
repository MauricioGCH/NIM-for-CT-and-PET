...
#ifndef OTABLEFOCUS_HH
#define OTABLEFOCUS_HH 1

class oTableFocus
{
  // Constructor & Destructor
  public:
    oTableFocus( int f_NbElem, int f_NbView, int f_NbSino, int f_MaxRingDiff, int f_Span, oScanner* fp_Scanner, int f_Verbose );
    oTableFocus( int f_Mash, int f_MaxRingDiff, int f_Span, oScanner* f_Scanner, int f_Verbose );
    ~oTableFocus();
