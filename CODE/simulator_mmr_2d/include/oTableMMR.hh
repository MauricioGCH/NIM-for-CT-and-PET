...
#ifndef OTABLEMMR_HH
#define OTABLEMMR_HH 1

class oTableMMR
{
  // Constructor & Destructor
  public:
    oTableMMR( int f_NbElem, int f_NbView, int f_NbSino, int f_MaxRingDiff, int f_Span, oScanner* fp_Scanner, int f_Verbose );
    oTableMMR( int f_Mash, int f_MaxRingDiff, int f_Span, oScanner* f_Scanner, int f_Verbose );
    ~oTableMMR();
