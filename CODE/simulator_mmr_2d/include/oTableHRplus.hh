...
#ifndef OTABLEHRPLUS_HH
#define OTABLEHRPLUS_HH 1

class oTableHRplus
{
  // Constructor & Destructor
  public:
    oTableHRplus( int f_NbElem, int f_NbView, int f_NbSino, int f_MaxRingDiff, int f_Span, oScanner* fp_Scanner, int f_Verbose );
    oTableHRplus( int f_Mash, int f_MaxRingDiff, int f_Span, oScanner* f_Scanner, int f_Verbose );
    ~oTableHRplus();
